                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="p-8">
                        <div className="flex items-center gap-3 mb-8 pb-6 border-b border-gray-50">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-800">Form Pendaftaran Siswa</h3>
                                <p className="text-sm text-gray-500">Lengkapi data di bawah untuk membuat akun siswa baru.</p>
                            </div>
                        </div>
