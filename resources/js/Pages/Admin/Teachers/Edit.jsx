...
export default function Edit({ auth, teacher }) {
    ...
    return (
        ...
        >
            <Head title={`Modify ${teacher.name}`} />
                    ...
                    <div className="p-10">
                        <div className="flex items-center gap-6 mb-12 pb-10 border-b border-slate-50">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-2 italic">Perbarui metadata identitas dan hak akses untuk personil pengajar.</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-10">
                            ...
                            <div className="pt-10 border-t border-slate-50">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Verify Secret Rotation</label>
                                        <TextInput
